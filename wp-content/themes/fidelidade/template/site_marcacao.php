...
<div class="container">    
    <div class="py-3 text-center topo mt-1"> 
        ...
        <div class="form-group card p-2" id="tempoLimiteMarcacao">     
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group text-center">
                        <label>Valor(R$)  </label> 
                        <input type="text" class="form-control dinheiro mt-2 mb-2" id="valorMarcacao" placeholder="R$"/>
                        <a href="#" class="mt-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <span class="badge rounded-pill bg-primary ml-2">Inserir Observação</span>
                        </a>
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                             <div class="mb-3">
                                <label class="form-label">Observação adicional sobre a marcação</label>
                                <textarea class="form-control" id="obsadicional" name="obsadicional" rows="3"></textarea>
                              </div>
                            </div>
