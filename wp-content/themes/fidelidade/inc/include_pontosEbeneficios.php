    ...
    <div class="col-lg-12">
        ...
        <div class="row mt-5 formDetalheBeneficio">
            ...
            <div class="col-lg-6 mt-3">
                ...
                <select class="form-select status-beneficio" aria-label=".form-select-sm example" name="status" id="status">
                    <option value="ativo" <?= $beneficio[0]->status == 'ativo' ? 'selected' : '' ?> selected>Ativo</option>
                    <option value="inativo" <?= $beneficio[0]->status == 'inativo' ? 'selected' : '' ?>>Inativo</option>
                </select>
            </div>
        </div>
...
<script>
    ...
    $(".updateBeneficio").on("click", function () { 
        ...
        setTimeout(function(){
            ...
            data: { vlrPts: $(".vlrPontos").val(),  idBeneficio: $('.idBeneficio').val(), status: $(".status-beneficio").val()  }
